  ...
  return (
    <section id="cta" className="relative z-20 py-16 md:py-24">
      <div className="container max-w-6xl mx-auto px-4">
        <div className="relative rounded-[3rem] md:rounded-[4rem] bg-[#F7F5FB] overflow-hidden flex flex-col md:flex-row items-stretch shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-lavender/30">
          
          {/* Left Content */}
          <div className="flex-1 p-10 md:p-14 lg:p-16 z-10 flex flex-col justify-center">
            <div className="inline-flex self-start items-center gap-2 px-4 py-1.5 rounded-full bg-white text-lavender-strong font-bold text-xs uppercase tracking-widest mb-6 shadow-sm">
              <Sparkles className="w-3.5 h-3.5" />
              Enroll Today
            </div>
            
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-display text-foreground leading-[1.2] mb-6">
              Give your child the <span className="text-lavender-strong italic font-medium">best start</span> in life
            </h2>
            ...
            <Link 
              href="/contact"
              className="inline-flex self-start items-center gap-3 px-8 py-3.5 rounded-full bg-lavender-strong text-white font-bold text-base hover:bg-lavender-strong/90 hover:-translate-y-0.5 transition-all duration-300 shadow-md group"
            >
              Contact Us Now
          ...
          <div className="flex-1 w-full min-h-[350px] md:min-h-full relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#F7F5FB] via-[#F7F5FB]/70 to-transparent z-10 w-full md:w-1/3"></div>
